...
ok('head to head starts collapsed', !$('.mc-h2h--open') && $('#mcH2hToggle')?.getAttribute('aria-expanded') === 'false');
ok('the toggle invites a look', $('#mcH2hToggle span')?.textContent === 'View head-to-head');
ok('the record is wrapped for hiding', !!$('.mc-h2h-body .mc-bar') && !!$('.mc-h2h-body .mc-meetings'));
click($('#mcH2hToggle'));
ok('tapping it opens the record', $('.mc-h2h')?.classList.contains('mc-h2h--open') && $('#mcH2hToggle')?.getAttribute('aria-expanded') === 'true');
ok('and offers to hide it again', $('#mcH2hToggle span')?.textContent === 'Hide head-to-head');
click($('#mcH2hToggle'));
ok('tapping again closes it', !$('.mc-h2h--open') && $('#mcH2hToggle span')?.textContent === 'View head-to-head');
click($('#mcH2hToggle'));
...
ok('a fresh card opens with the record collapsed again', !$('.mc-h2h--open'));
