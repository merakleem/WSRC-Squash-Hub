...
export const EVENTS = {
  upcoming: [
    ...
    { id:3, name:'Doubles Night', description:'Casual doubles, partners drawn on the night. All levels welcome.', event_date:'2026-10-15', start_time:'18:30', end_time:null, members_only:1, guests_allowed:1, max_people:null, members_count:15, guests_count:4, total:19, spots_left:null, full:false, my_signup:{guests:1}, link:null, preview:A(['Yusuf Demir','Clara Nowak','Daniel Okafor']) },
