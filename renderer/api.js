...
if (typeof window !== 'undefined' && !window.api) {
  ...
  window.api = {
    ...
    updateSettings:    (d)  => _apiFetch('PUT', '/api/settings', d),
    getSeasons:        ()      => _apiFetch('GET',    '/api/seasons'),
    addSeason:         (d)     => _apiFetch('POST',   '/api/seasons', d),
    updateSeason:      (id, d) => _apiFetch('PUT',    `/api/seasons/${id}`, d),
    setCurrentSeason:  (id)    => _apiFetch('PUT',    `/api/seasons/${id}/current`),
    deleteSeason:      (id)    => _apiFetch('DELETE', `/api/seasons/${id}`),
    setLeagueSeason:   (id, seasonId) => _apiFetch('PUT', `/api/leagues/${id}/season`, { season_id: seasonId }),
    ...
    messagePlayer:        (id, d) => _apiFetch('POST',   `/api/players/${id}/message`, d),
